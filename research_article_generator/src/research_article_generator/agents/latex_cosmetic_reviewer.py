...
_SYSTEM_PROMPT = (
    "You are a LaTeX formatting reviewer for research articles targeting journal publication. "
    ...
    "- Journal template compliance: respect document class conventions\n\n"
    "SAFE_ZONE awareness: do NOT flag content inside SAFE_ZONE markers — "
    "that content is read-only and managed by other pipeline stages.\n\n"
